            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="px-12 text-justify lg:max-w-2xl">
                    <p className="mx-auto text-sm leading-relaxed w-full text-grey ">
                        ...
                        yang berkelanjutan. Fokus utama kami adalah pada implementasi ESG (Environmental, Social, and Governance) 
                        serta GRC (Governance, Risk, and Compliance) untuk memastikan keberlanjutan jangka panjang dan tanggung jawab 
